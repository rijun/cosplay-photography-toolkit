...
urlpatterns = [
    ...
    path(
        'g/<str:token>/download/<uuid:download_id>/progress',
        views.zip_download_progress,
        name='zip_download_progress',
    ),
    path('g/<str:token>/download/<uuid:download_id>/cancel', views.cancel_zip_download, name='cancel_zip_download'),
